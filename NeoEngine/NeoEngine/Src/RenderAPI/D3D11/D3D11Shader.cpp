	...
	void D3D11VertexShader::_CreateVertexLayout(eVertexType vertType)
	{
		...
		case eVertexType_Instanced:
		{
			D3D11_INPUT_ELEMENT_DESC layout[] =
			{
				...
				{ "INSTANCEDATA", 1, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 16, D3D11_INPUT_PER_INSTANCE_DATA, 1},
				{ "INSTANCEDATA", 2, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 32, D3D11_INPUT_PER_INSTANCE_DATA, 1},
				{ "INSTANCEDATA", 3, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 48, D3D11_INPUT_PER_INSTANCE_DATA, 1},
			};
