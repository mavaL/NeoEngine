/********************************************************************
	created:	2016/10/26 17:54
	filename	TerrainGroup.h
	author:		maval

	purpose:	
*********************************************************************/
#ifndef TerrainGroup_h__
#define TerrainGroup_h__
...
namespace Neo
{
	...
	*/
	...
	public:
		...
		*/
		TerrainGroup(Terrain::Alignment align, uint16 terrainSize, float terrainWorldSize);
		...
		*/
		virtual const VEC3& getOrigin() const { return mOrigin; }
		...
		*/
		virtual float getTerrainWorldSize() const { return mTerrainWorldSize; }
		...
		*/
        virtual void setTerrainWorldSize(float newWorldSize);
		...
		*/
		struct RayResult
		{
			...
			RayResult(bool _hit, Terrain* _terrain, const VEC3& _pos)
		...
		*/
		float getHeightAtWorldPosition(float x, float y, float z, Terrain** ppTerrain = 0);
		...
		with the terrain that was found to resolve this query, or null if none were
		*/
		float getHeightAtWorldPosition(const VEC3& pos, Terrain** ppTerrain = 0);
		 ...
		 */
		RayResult rayIntersects(const RAY& ray, float distanceLimit = 0) const; 
		...
		*/
		void boxIntersects(const AABB& box, TerrainList* resultList) const;
		...
		*/
		void convertWorldPositionToTerrainSlot(const VEC3& pos, long *x, long *y) const;
		...
		*/
		void convertTerrainSlotToWorldPosition(long x, long y, VEC3* pos) const;
		...
		*/
		...
		typedef std::map<uint32, TerrainSlot*>::iterator TerrainIterator;
		typedef std::map<uint32, TerrainSlot*>::const_iterator ConstTerrainIterator;
...
//		ConstTerrainIterator getTerrainIterator() const;
	...
	protected:
		...
		VEC3 getTerrainSlotPosition(long x, long y);
