/********************************************************************
	created:	2016/05/03 11:40
	filename	ConvexBody.h
	author:		maval
...
namespace Neo
{
	...
	*/
	...
	public:
		...
		*/
		void define(const Camera& frustum);
		...
		*/
		void clip( const Camera& frustum );
		...
		*/
		const VEC3& getVertex( size_t poly, size_t vertex ) const;

		/** Returns the normal of a specified polygon.
		*/
		const VEC3& getNormal( size_t poly );
	...
	protected:
		...
		*/
		void insertVertex(size_t poly, const VEC3& vdata, size_t vertex);
		/** Inserts a vertex for a polygon at the end.
		@note
			No checks are done whether the assembled polygon is (still) planar, 
			the caller must ensure that this is the case.
		*/
		void insertVertex(size_t poly, const VEC3& vdata);
		...
		*/
		...
		@note
			...
			the caller must ensure that this is the case.
		*/
		void setVertex( size_t poly, const VEC3& vdata, size_t vertex );
		...
		*/
		bool findAndEraseEdgePair(const VEC3& vec, 
