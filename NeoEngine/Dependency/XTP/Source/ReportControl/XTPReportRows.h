...
public:
	...
	//-----------------------------------------------------------------------
	virtual int GetTopRowIndex() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the currently top row index.
	//-----------------------------------------------------------------------
	virtual void SetTopRowIndex(int nTopRow);
...
AFX_INLINE int CXTPReportRows::GetTopRowIndex() const
{
	return m_nTopRow;
}

AFX_INLINE void CXTPReportRows::SetTopRowIndex(int nTopRow)
{
	m_nTopRow = nTopRow;
}
